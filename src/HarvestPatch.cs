...
namespace SkillAdjustment
{
    ...
    internal class HarvestAdjustment
    {
        public static void Postfix(SkillsManager __instance)
        {
            ...
            carcassHarvesting.m_MeatTimePercentDecrease[0] = settings.meatHarvestTime1;

            carcassHarvesting.m_FrozenThresholdPercent[1] = settings.harvestFrozen2;
            carcassHarvesting.m_HideGutTimePercentDecrease[1] = settings.hideGutHarvestTime2;
            carcassHarvesting.m_MeatTimePercentDecrease[1] = settings.meatHarvestTime2;

            carcassHarvesting.m_FrozenThresholdPercent[2] = settings.harvestFrozen3;
            carcassHarvesting.m_HideGutTimePercentDecrease[2] = settings.hideGutHarvestTime3;
            carcassHarvesting.m_MeatTimePercentDecrease[2] = settings.meatHarvestTime3;

            carcassHarvesting.m_FrozenThresholdPercent[3] = settings.harvestFrozen4;
            carcassHarvesting.m_HideGutTimePercentDecrease[3] = settings.hideGutHarvestTime4;
            carcassHarvesting.m_MeatTimePercentDecrease[3] = settings.meatHarvestTime4;

            carcassHarvesting.m_FrozenThresholdPercent[4] = settings.harvestFrozen5;
            carcassHarvesting.m_HideGutTimePercentDecrease[4] = settings.hideGutHarvestTime5;
            carcassHarvesting.m_MeatTimePercentDecrease[4] = settings.meatHarvestTime5;
