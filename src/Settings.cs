...
namespace SkillAdjustment
{
    internal class Settings : JsonModSettings
    {
        ...
        [Description("Adjust arrow damage. (Game default = 0%)")]
        [Slider(0, 200)]
        public int bowDamage1 = 0;

        [Name("         - Critical Hit Chance")]
        [Description("Adjust critical hit chance. (Game default = 0%)")]
        [Slider(0, 100)]
        public int bowCritical1 = 0;

        [Name("         - Bleed Out Time Reduction")]
        [Description("Reduce the time it takes for animals to bleed out. (Game default = 0%)")]
        [Slider(0, 100)]
        public int bowBleedOut1 = 0;

        [Name("         - Condition loss")]
        [Description("Reduce the amount of condition your bow losses after each use. (Game default = 0%)")]
        [Slider(0, 100)]
        public int bowPerUseConditionLoss1 = 0;

        [Name("Archery Level 2 ------------------------------")]
        [Description("Show or hide level 2 skills")]
        [Choice("+", "-")]
        public bool archery2 = false;

        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 15)")]
        [Slider(15, 500)]
        ...
        [Name("         - Damage Increase")]
        [Description("Adjust arrow damage. (Game default = 10%)")]
        [Slider(0, 200)]
        ...
        [Description("Show or hide level 3 skills")]
        [Choice("+", "-")]
        public bool archery3 = false;

        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 40)")]
        [Slider(40, 500)]
        ...
        [Name("         - Critical Hit Chance")]
        [Description("Adjust critical hit chance. (Game default = 15%)")]
        [Slider(0, 100)]
        ...
        [Description("Show or hide level 4 skills")]
        [Choice("+", "-")]
        public bool archery4 = false;

        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 75)")]
        [Slider(75, 500)]
        ...
        [Name("         - Critical Hit Chance")]
        [Description("Adjust critical hit chance. (Game default = 25%)")]
        [Slider(0, 100)]
        public int bowCritical4 = 25;

        [Name("         - Bleed Out Time Reduction")]
        [Description("Reduce the time it takes for animals to bleed out. (Game default = 25%)")]
        [Slider(0, 100)]
        public int bowBleedOut4 = 25;

        [Name("         - Condition loss")]
        [Description("Reduce the amount of condition your bow losses after each use. (Game default = 50%)")]
        [Slider(0, 100)]
        public int bowPerUseConditionLoss4 = 50;

        [Name("Archery Level 5 ------------------------------")]
        [Description("Show or hide level 5 skills")]
        [Choice("+", "-")]
        public bool archery5 = false;

        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 125)")]
        [Slider(125, 625)]
        ...
        [Name("         - Damage Increase")]
        [Description("Adjust arrow damage. (Game default = 25%)")]
        [Slider(0, 200)]
        public int bowDamage5 = 25;

        [Name("         - Critical Hit Chance")]
        [Description("Adjust critical hit chance. (Game default = 50%)")]
        [Slider(0, 100)]
        public int bowCritical5 = 50;

        [Name("         - Bleed Out Time Reduction")]
        [Description("Reduce the time it takes for animals to bleed out. (Game default = 50%)")]
        [Slider(0, 100)]
        ...
        [Description("Show or hide harvesting Skills. \n\nAll changes made in game require a game reload to take effect")]
        [Choice("+", "-")]
        ...
        [Description("Adjust how frozen a carcass can be to harvest with bare hands. (Game default = 50% frozen)")]
        [Slider(0, 100)]
        public int harvestFrozen1 = 50;

        [Name("         - Meat harvesting")]
        [Description("Reduce the time it takes to harvest meat. \n(Game default = 0%)")]
        [Slider(0, 99)]
        public int meatHarvestTime1 = 0;

        [Name("         - Hide & gut harvesting")]
        [Description("Reduce the time it takes to harvest hides and guts. (Game default = 0%)")]
        [Slider(0, 99)]
        ...
        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 30)")]
        [Slider(30, 1250)]
        public int harvestTier3 = 30;

        [Name("         - Frozen carcass harvesting")]
        [Description("Adjust how frozen a carcass can be to harvest with bare hands. (Game default = 50%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Hide & gut harvesting")]
        [Description("Reduce the time it takes to harvest hides and guts. (Game default = 10%)")]
        [Slider(0, 99)]
        ...
        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 50)")]
        [Slider(50, 1250)]
        public int harvestTier4 = 50;

        [Name("         - Frozen carcass harvesting")]
        [Description("Adjust how frozen a carcass can be to harvest with bare hands. (Game default = 75%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Hide & gut harvesting")]
        [Description("Reduce the time it takes to harvest hides and guts. (Game default = 20%)")]
        [Slider(0, 99)]
        ...
        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 100)")]
        [Slider(100, 1250)]
        public int harvestTier5 = 100;

        [Name("         - Frozen carcass harvesting")]
        [Description("Adjust how frozen a carcass can be to harvest with bare hands. (Game default = 100%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Hide & gut harvesting")]
        [Description("Reduce the time it takes to harvest hides and guts. (Game default = 30%)")]
        [Slider(0, 99)]
        ...
        [Name("Cooking Skills")]
        [Description("Show or hide cooking Skills.  \n\nAll changes made in game require a game reload to take effect")]
        [Choice("+", "-")]
        public bool cooking = false;

        //
        [Name("Smashing open cans")]
        [Description("Skill level required to not lose calories when smashing open cans. (Game default = 3) \n(6 = Calories are always lost)")]
        [Slider(1, 6)]
        public int noCalorieLossLevel = 3;

        [Name("Parasites & Posion")]
        [Description("Skill level required to not be affected by parasites and poison from cooked food. (Game default = 5) \n(6 = Always a chance for parasites and poison)")]
        [Slider(1, 6)]
        ...
        [Name("         - Calorie bonus")]
        [Description("Adjust the amount of additional calories gained from cooked food. (Game default = 0%)")]
        [Slider(0, 100)]
        public int calorieBonus1 = 0;

        [Name("         - Cooking time")]
        [Description("Reduce the time it takes to cook food. \n(Game default = 0%)")]
        [Slider(0, 99)]
        public int reduceCookingTime1 = 0;

        [Name("         - Ready times")]
        [Description("Adjust Ready times. (Game default = 0%)")]
        [Slider(0, 99)]
        ...
        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 25)")]
        [Slider(25, 1750)]
        public int cookingTier2 = 25;

        [Name("         - Calorie bonus")]
        [Description("Adjust the amount of additional calories gained from cooked food. (Game default = 10%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Calorie bonus")]
        [Description("Adjust the amount of additional calories gained from cooked food. (Game default = 15%)")]
        [Slider(0, 100)]
        ...
        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 150)")]
        [Slider(150, 1750)]
        public int cookingTier4 = 150;

        [Name("         - Calorie bonus")]
        [Description("Adjust the amount of additional calories gained from cooked food. (Game default = 20%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Ready times")]
        [Description("Adjust Ready times. (Game default = 20%)")]
        [Slider(0, 99)]
        ...
        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 350)")]
        [Slider(350, 1750)]
        public int cookingTier5 = 350;

        [Name("         - Calorie bonus")]
        [Description("Adjust the amount of additional calories gained from cooked food. (Game default = 25%)")]
        [Slider(0, 100)]
        ...
        [Description("Show or hide Rifle Skills. \n\nAll changes made in game require a game reload to take effect")]
        [Choice("+", "-")]
        public bool fireStarting = false;

        //Tinder Requirement
        [Name("Tinder Requirement")]
        [Description("Skill level required to start fires without tinder. (Game default = 3) (6 = Tinder is always required)")]
        [Slider(1, 6)]
        ...
        [Description("Adjust the bonus to fire starting chance. \n(Game default = 40%)")]
        [Slider(0, 100)]
        public int fireBaseChance1 = 40;

        [Name("         - Longer Lasting Fires")]
        [Description("Adjust the bonus to how much longer fires last. (Game default = 0%)")]
        [Slider(0, 200)]
        public int fireDurationBonus1 = 0;

        [Name("         - Quicker Fire Starting")]
        [Description("Adjust the bonus to how fast you start fires. \n(Game default = 0%)")]
        [Slider(0, 100)]
        ...
        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 20)")]
        [Slider(20, 500)]
        ...
        [Name("         - Longer Lasting Fires")]
        [Description("Adjust the bonus to how much longer fires last. (Game default = 10%)")]
        [Slider(0, 200)]
        ...
        [Name("         - Longer Lasting Fires")]
        [Description("Adjust the bonus to how much longer fires last. (Game default = 25%)")]
        [Slider(0, 200)]
        ...
        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 200)")]
        [Slider(200, 1000)]
        ...
        [Name("         - Longer Lasting Fires")]
        [Description("Adjust the bonus to how much longer fires last. (Game default = 50%)")]
        [Slider(0, 200)]
        ...
        [Description("Show or hide Gunsmithing Skills. \n\nAll changes made in game require a game reload to take effect")]
        [Choice("+", "-")]
        ...
        [Description("Adjust the amount of condition your crafted ammunition will have. (Game default = 20%)")]
        [Slider(0, 100)]
        public int ammoCraft1 = 20;

        [Name("          Ammunition harvesting")]
        [Description("Adjust the bonus chance to harvest ammunition components. (Game default = 50%)")]
        [Slider(0, 100)]
        public int ammoHarvest1 = 50;

        [Name("          Repair Condition")]
        [Description("Adjust the amount of condition your guns will gain when using a milling machine. (Game default = 40%)")]
        [Slider(0, 100)]
        public int repairCon1 = 40;

        [Name("          Repair success chance")]
        [Description("Adjust the bonus chance of milling repair success. (Game default = 50%)")]
        [Slider(0, 100)]
        ...
        [Name("          Ammunition crafting")]
        [Description("Adjust the amount of condition your crafted ammunition will have. (Game default = 40%)")]
        [Slider(0, 100)]
        public int ammoCraft2 = 40;

        [Name("          Ammunition harvesting")]
        [Description("Adjust the bonus chance to harvest ammunition components. (Game default = 60%)")]
        [Slider(0, 100)]
        public int ammoHarvest2 = 60;

        [Name("          Repair Condition")]
        [Description("Adjust the amount of condition your guns will gain when using a milling machine. (Game default = 60%)")]
        [Slider(0, 100)]
        public int repairCon2 = 60;

        [Name("          Repair success chance")]
        [Description("Adjust the bonus chance of milling repair success. (Game default = 60%)")]
        [Slider(0, 100)]
        ...
        [Name("          Ammunition crafting")]
        [Description("Adjust the amount of condition your crafted ammunition will have. (Game default = 60%)")]
        [Slider(0, 100)]
        public int ammoCraft3 = 60;

        [Name("          Ammunition harvesting")]
        [Description("Adjust the bonus chance to harvest ammunition components. (Game default = 70%)")]
        [Slider(0, 100)]
        public int ammoHarvest3 = 70;

        [Name("          Repair Condition")]
        [Description("Adjust the amount of condition your guns will gain when using a milling machine. (Game default = 80%)")]
        [Slider(0, 100)]
        public int repairCon3 = 80;

        [Name("          Repair success chance")]
        [Description("Adjust the bonus chance of milling repair success. (Game default = 75%)")]
        [Slider(0, 100)]
        ...
        [Name("          Ammunition crafting")]
        [Description("Adjust the amount of condition your crafted ammunition will have. (Game default = 80%)")]
        [Slider(0, 100)]
        public int ammoCraft4 = 80;

        [Name("          Ammunition harvesting")]
        [Description("Adjust the bonus chance to harvest ammunition components. (Game default = 80%)")]
        [Slider(0, 100)]
        public int ammoHarvest4 = 80;

        [Name("          Repair Condition")]
        [Description("Adjust the amount of condition your guns will gain when using a milling machine. (Game default = 90%)")]
        [Slider(0, 100)]
        public int repairCon4 = 90;

        [Name("          Repair success chance")]
        [Description("Adjust the bonus chance of milling repair success. (Game default = 90%)")]
        [Slider(0, 100)]
        ...
        [Name("          Ammunition crafting")]
        [Description("Adjust the amount of condition your crafted ammunition will have. (Game default = 100%)")]
        [Slider(0, 100)]
        public int ammoCraft5 = 100;

        [Name("          Ammunition harvesting")]
        [Description("Adjust the bonus chance to harvest ammunition components. (Game default = 100%)")]
        [Slider(0, 100)]
        public int ammoHarvest5 = 100;

        [Name("          Repair Condition")]
        [Description("Adjust the amount of condition your guns will gain when using a milling machine. (Game default = 100%)")]
        [Slider(0, 100)]
        public int repairCon5 = 100;

        [Name("          Repair success chance")]
        [Description("Adjust the bonus chance of milling repair success. (Game default = 100%)")]
        [Slider(0, 100)]
        ...
        [Description("Show or hide Ice Fishing Skills. \n\nAll changes made in game require a game reload to take effect")]
        [Choice("+", "-")]
        ...
        [Description("Adjust the bonus weight of fish you catch. \n(Game default = 0%)")]
        [Slider(0, 200)]
        public int fishWeight1 = 0;

        [Name("          Fishing time")]
        [Description("Reduce the amount of time it takes to catch fish. (Game default = 0%)")]
        [Slider(0, 99)]
        public int fishingTime1 = 0;

        [Name("          Chance of line breaking")]
        [Description("Adjust the chance that your line will break while fishing. (Game default = 12%)")]
        [Slider(0, 100)]
        ...
        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 10)")]
        [Slider(10, 500)]
        ...
        [Name("          Fishing time")]
        [Description("Reduce the amount of time it takes to catch fish. (Game default = 5%)")]
        [Slider(0, 50)]
        public int fishingTime2 = 5;

        [Name("          Chance of line breaking")]
        [Description("Adjust the chance that your line will break while fishing. (Game default = 8%)")]
        [Slider(0, 100)]
        ...
        [Name("          Fishing time")]
        [Description("Reduce the amount of time it takes to catch fish. (Game default = 10%)")]
        [Slider(0, 50)]
        public int fishingTime3 = 10;

        [Name("          Chance of line breaking")]
        [Description("Adjust the chance that your line will break while fishing. (Game default = 5%)")]
        [Slider(0, 100)]
        ...
        [Name("          Fishing time")]
        [Description("Reduce the amount of time it takes to catch fish. (Game default = 20%)")]
        [Slider(0, 50)]
        public int fishingTime4 = 20;

        [Name("          Chance of line breaking")]
        [Description("Adjust the chance that your line will break while fishing. (Game default = 3%)")]
        [Slider(0, 100)]
        ...
        [Name("         - XP for level up")]
        [Description("Set the number of skill points needed to level up to next tier. (Game default = 250)")]
        [Slider(250, 1250)]
        ...
        [Name("          Fishing time")]
        [Description("Reduce the amount of time it takes to catch fish. (Game default = 30%)")]
        [Slider(0, 50)]
        public int fishingTime5 = 30;

        [Name("          Chance of line breaking")]
        [Description("Adjust the chance that your line will break while fishing. (Game default = 1%)")]
        [Slider(0, 100)]
        ...
        [Name("Mending Skills")]
        [Description("Show or hide Mending Skills. \n\nAll changes made in game require a game reload to take effect")]
        [Choice("+", "-")]
        ...
        [Name("         - Success chance")]
        [Description("Adjust the chance of success to repair clothing. (Game default = 50%)")]
        [Slider(0, 100)]
        public int mendingSuccessChance1 = 50;

        [Name("         - Bonus Condition")]
        [Description("Adjust the bonus to extra condition gained to repaired clothing. (Game default = 0%)")]
        [Slider(0, 200)]
        public int mendingConditionBonus1 = 0;

        [Name("         - Reduce repair time")]
        [Description("Reduce the amount of time it takes to repair clothing. (Game default = 0%)")]
        [Slider(0, 99)]
        public int mendingRepairTimeReduced1 = 0;

        [Name("         - Sewing kit use")]
        [Description("Reduce the amount of condition sewing kits lose after each use. (Game default = 0%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Success chance")]
        [Description("Adjust the chance of success to repair clothing. (Game default = 65%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Reduce repair time")]
        [Description("Reduce the amount of time it takes to repair clothing. (Game default = 10%)")]
        [Slider(0, 99)]
        ...
        [Name("         - Success chance")]
        [Description("Adjust the chance of success to repair clothing. (Game default = 75%)")]
        [Slider(0, 100)]
        public int mendingSuccessChance3 = 75;

        [Name("         - Bonus Condition")]
        [Description("Adjust the bonus to extra condition gained to repaired clothing. (Game default = 10%)")]
        [Slider(0, 200)]
        public int mendingConditionBonus3 = 10;

        [Name("         - Reduce repair time")]
        [Description("Reduce the amount of time it takes to repair clothing. (Game default = 15%)")]
        [Slider(0, 99)]
        public int mendingRepairTimeReduced3 = 15;

        [Name("         - Sewing kit use")]
        [Description("Reduce the amount of condition sewing kits lose after each use. (Game default = 10%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Success chance")]
        [Description("Adjust the chance of success to repair clothing. (Game default = 85%)")]
        [Slider(0, 100)]
        public int mendingSuccessChance4 = 85;

        [Name("         - Bonus Condition")]
        [Description("Adjust the bonus to extra condition gained to repaired clothing. (Game default = 15%)")]
        [Slider(0, 200)]
        public int mendingConditionBonus4 = 15;

        [Name("         - Reduce repair time")]
        [Description("Reduce the amount of time it takes to repair clothing. (Game default = 25%)")]
        [Slider(0, 99)]
        public int mendingRepairTimeReduced4 = 25;

        [Name("         - Sewing kit use")]
        [Description("Reduce the amount of condition sewing kits lose after each use. (Game default = 25%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Success chance")]
        [Description("Adjust the chance of success to repair clothing. (Game default = 100%)")]
        [Slider(0, 100)]
        public int mendingSuccessChance5 = 100;

        [Name("         - Bonus Condition")]
        [Description("Adjust the bonus to extra condition gained to repaired clothing. (Game default = 25%)")]
        [Slider(0, 200)]
        public int mendingConditionBonus5 = 25;

        [Name("         - Reduce repair time")]
        [Description("Reduce the amount of time it takes to repair clothing. (Game default = 40%)")]
        [Slider(0, 99)]
        public int mendingRepairTimeReduced5 = 40;

        [Name("         - Sewing kit use")]
        [Description("Reduce the amount of condition sewing kits lose after each use. (Game default = 35%)")]
        [Slider(0, 100)]
        ...
        [Description("Show or hide Revolver Skills. \n\nAll changes made in game require a game reload to take effect")]
        [Choice("+", "-")]
        ...
        [Description("Reduce the amount of condition revolvers lose after each use. (Game default = 0%)")]
        [Slider(0, 100)]
        ...
        [Description("Adjust recoil compensation. (Game default = 0%)")]
        [Slider(0, 100)]
        public int revolverRecoil1 = 0;

        [Name("         - Struggle bonus")]
        [Description("Adjust how effective a revolver is during a struggle. (Game default = 0%)")]
        [Slider(0, 200)]
        public int revolverStruggleBonus1 = 0;

        [Name("         - Condition repair bonus")]
        [Description("Adjust the bonus to extra condition recieved from repairing. (Game default = 0)")]
        [Slider(0, 100)]
        public int revolverRepairBonus1 = 0;

        [Name("         - Damage bonus")]
        [Description("Adjust damage bonus. (Game default = 0%)")]
        [Slider(0, 200)]
        ...
        [Name("         - Condition repair bonus")]
        [Description("Adjust the bonus to extra condition recieved from repairing. (Game default = +2)")]
        [Slider(0, 100)]
        ...
        [Name("         - Struggle bonus")]
        [Description("Adjust how effective a revolver is during a struggle. (Game default = 10%)")]
        [Slider(0, 200)]
        public int revolverStruggleBonus3 = 10;

        [Name("         - Condition repair bonus")]
        [Description("Adjust the bonus to extra condition recieved from repairing. (Game default = +3)")]
        [Slider(0, 100)]
        ...
        [Name("         - Struggle bonus")]
        [Description("Adjust how effective a revolver is during a struggle. (Game default = 20%)")]
        [Slider(0, 200)]
        public int revolverStruggleBonus4 = 20;

        [Name("         - Condition repair bonus")]
        [Description("Adjust the bonus to extra condition recieved from repairing. (Game default = +4)")]
        [Slider(0, 100)]
        ...
        [Name("         - Condition loss on use")]
        [Description("Reduce the amount of condition revolvers lose after each use. (Game default = 50%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Struggle bonus")]
        [Description("Adjust how effective a revolver is during a struggle. (Game default = 30%)")]
        [Slider(0, 200)]
        public int revolverStruggleBonus5 = 30;

        [Name("         - Condition repair bonus")]
        [Description("Adjust the bonus to extra condition recieved from repairing. (Game default = +5)")]
        [Slider(0, 100)]
        ...
        [Description("Adjust critical Hit chance. \n(Game default = 0%)")]
        [Slider(0, 100)]
        public int rifleCritical1 = 0;

        [Name("         - Repair Bonus")]
        [Description("Adjust the amount of extra condition a rifle will recieve from repairing. (Game default = 0%)")]
        [Slider(0, 100)]
        public int rifleRepairBonus1 = 0;

        [Name("         - Accuracy")]
        [Description("Adjust the bonus to accuracy with rifles. \n(Game default = 0%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Condition Loss")]
        [Description("Reduce the amount of condition rifles lose after each use. (Game default = 0%)")]
        [Slider(0, 100)]
        public int rifleLessDegradeOnUse1 = 0;

        [Name("         - Aim assist")]
        [Description("Adjust the bonus to aim assist. (Game default = 0.0)")]
        [Slider(0.00f, 1.00f, NumberFormat = "{0:#.00}")]
        public float rifleAimAssist1 = 0.00f;

        [Name("         - Effective range")]
        [Description("Adjust the effective range of rifles. \n(Game default = 75)")]
        [Slider(75, 350)]
        public int rifleEffectiveRange1 = 75;

        [Name("         - Stability bonus")]
        [Description("Adjust the bonus to stability. (Game default = 0)")]
        [Slider(0, 100)]
        ...
        [Name("         - Repair Bonus")]
        [Description("Adjust the amount of extra condition a rifle will recieve from repairing. (Game default = 2%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Aim assist")]
        [Description("Adjust the bonus to aim assist. (Game default = 0.2)")]
        [Slider(0.00f, 1.00f, NumberFormat = "{0:#.00}")]
        ...
        [Name("         - Stability bonus")]
        [Description("Adjust the bonus to stability. (Game default = 10)")]
        [Slider(0, 100)]
        ...
        [Name("         - Aim assist")]
        [Description("Adjust the bonus to aim assist. (Game default = 0.35)")]
        [Slider(0.00f, 1.00f, NumberFormat = "{0:#.00}")]
        ...
        [Name("         - Stability bonus")]
        [Description("Adjust the bonus to stability. (Game default = 20)")]
        [Slider(0, 100)]
        ...
        [Name("         - Damage Bonus")]
        [Description("Adjust damage bonus. (Game default = 10%)")]
        [Slider(0, 200)]
        ...
        [Name("         - Aim assist")]
        [Description("Adjust the bonus to aim assist. (Game default = 0.5)")]
        [Slider(0.00f, 1.00f, NumberFormat = "{0:#.00}")]
        ...
        [Name("         - Stability bonus")]
        [Description("Adjust the bonus to stability. (Game default = 30)")]
        [Slider(0, 100)]
        ...
        [Name("         - Repair Bonus")]
        [Description("Adjust the amount of extra condition a rifle will recieve from repairing. (Game default = 5%)")]
        [Slider(0, 100)]
        ...
        [Name("         - Damage Bonus")]
        [Description("Adjust damage bonus. (Game default = 20%)")]
        [Slider(0, 200)]
        public int rifleDamage5 = 20;

        [Name("         - Condition Loss")]
        [Description("Reduce the amount of condition rifles lose after each use. (Game default = 50%)")]
        [Slider(0, 100)]
        public int rifleLessDegradeOnUse5 = 50;

        [Name("         - Aim assist")]
        [Description("Adjust the bonus to aim assist. (Game default = 0.6)")]
        [Slider(0.00f, 1.00f, NumberFormat = "{0:#.00}")]
        ...
        [Name("         - Stability bonus")]
        [Description("Adjust the bonus to stability. (Game default = 50)")]
        [Slider(0, 100)]
